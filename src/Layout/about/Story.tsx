...
const Story = () => {
  return (
    <div className="w-full h-auto bg-lightBlue relative pt-[80px]  ">
      <h1 className="font-bold font-navyBlue text-[36px] text-center mb-12">
        About NoDoseOff
      </h1>
      <div
      ...
      >
        <div className="md:w-1/2 h-auto gap-4 flex flex-col text-left md:py-6 font-Inter text-[16px]">
          <p>
