...
const Hero = () => {
  return (
    <div className="w-full h-auto bg-lightBlue relative pb-8 pt-[112px]">
      ...
      ss:gap-12 flex flex-col md:flex-row md:py-6">
        <div className="md:w-1/2 h-full flex flex-col justify-center gap-7 items-center md:items-start py-12">
          ...
          <h3 className="ss:text-[56px] text-[36px] text-center md:text-left font-bold w-full font-Poppins leading-snug">
            Supporting Long-Term and Daily Drug Users for Medication Adherence
          </h3>
        </div>
        <div className="md:w-1/2 md:py-8 h-full flex items-center justify-end">
